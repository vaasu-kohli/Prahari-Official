        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-2 flex flex-col gap-1">
              ...
              <a href="#" className="flex items-center gap-3 p-3 hover:bg-gray-50 rounded-xl transition-colors text-sm text-gray-700 font-medium opacity-50 cursor-not-allowed">
